...
import uk.ac.ebi.ampt2d.commons.accession.core.models.HistoryModel;
...
public class BasicAccessionHistoryController<DTO extends MODEL, MODEL, ACCESSION> {
    ...
    private HistoryService<ACCESSION> service;
    private ListConverter<HistoryModel, HistoryEventDTO> converter;

    public BasicAccessionHistoryController(HistoryService<ACCESSION> service, Function<MODEL, DTO> modelToDTO) {
